...
public class LibraryController {
    ...
    @PostMapping("")
    public Response<Void> addLibrary(@RequestBody Library library) {
        try {
            log.info("Add library {}", library);
            library.setOwner(CurrUserFacade.getUser());
    ...
    @DeleteMapping("/{id}")
    public Response<Void> deleteLibrary(@PathVariable int id) {
        try {
    ...
    @PutMapping("/{id}")
    public Response<Void> updateLibrary(@PathVariable int id, @RequestBody Library library) {
        try {
    ...
    public Response<Void> scanManga(@PathVariable int id) {
        try {
